  ...
  methods: {
    ...
    async submitPost() {
      if (!this.canSubmit)
        return;
      try {
        common_vendor.index.__f__("log", "at pages/forum/post.vue:90", "=== 开始发布话题 ===");
        const token = common_vendor.index.getStorageSync("token");
        common_vendor.index.__f__("log", "at pages/forum/post.vue:94", "存储的token:", token);
        let userInfo = common_vendor.index.getStorageSync("userInfo");
        common_vendor.index.__f__("log", "at pages/forum/post.vue:97", "原始userInfo:", userInfo);
        common_vendor.index.__f__("log", "at pages/forum/post.vue:98", "userInfo类型:", typeof userInfo);
        if (typeof userInfo === "string") {
          try {
            userInfo = JSON.parse(userInfo);
            common_vendor.index.__f__("log", "at pages/forum/post.vue:104", "解析后的userInfo:", userInfo);
          } catch (e) {
            common_vendor.index.__f__("error", "at pages/forum/post.vue:106", "解析userInfo失败:", e);
            userInfo = null;
          }
        }
        common_vendor.index.__f__("log", "at pages/forum/post.vue:111", "最终userInfo:", userInfo);
        common_vendor.index.__f__("log", "at pages/forum/post.vue:112", "是否有user_id:", userInfo && userInfo.user_id);
        if (!userInfo || !userInfo.user_id) {
          common_vendor.index.__f__("error", "at pages/forum/post.vue:115", "登录状态检查失败:", { userInfo, hasUserId: userInfo && userInfo.user_id });
        ...
        common_vendor.index.__f__("log", "at pages/forum/post.vue:132", "发布数据:", postData);
        ...
        common_vendor.index.__f__("error", "at pages/forum/post.vue:147", "发布失败:", error);
        common_vendor.index.showToast({
        ...
        common_vendor.index.__f__("log", "at pages/forum/post.vue:154", "=== 发布话题结束 ===");
      }
    }
  }
};
