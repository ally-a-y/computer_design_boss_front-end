  ...
  methods: {
    ...
    initAppTheme() {
      try {
        ...
        common_vendor.index.__f__("log", "at App.vue:36", "当前主题:", currentTheme, "主题模式:", themeMode);
        this.applyGlobalTheme(currentTheme);
        common_utils_themeSimple.themeManager.notifyThemeChange(currentTheme);
      } catch (error) {
        common_vendor.index.__f__("error", "at App.vue:45", "初始化主题失败:", error);
      }
    },
    /**
     * 应用全局主题
    ...
    applyGlobalTheme(theme) {
      common_vendor.index.__f__("log", "at App.vue:55", "应用主题:", theme);
    },
    /**
     * 监听系统主题变化
     */
    listenSystemThemeChange() {
      common_utils_themeSimple.themeManager.onSystemThemeChange((newTheme) => {
        common_vendor.index.__f__("log", "at App.vue:63", "系统主题变化:", newTheme);
