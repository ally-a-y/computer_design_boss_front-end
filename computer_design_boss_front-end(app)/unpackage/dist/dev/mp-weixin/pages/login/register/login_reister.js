...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: common_vendor.o($options.prevRegisterStep, "53"),
    b: common_vendor.o(($event) => $event.target.style.color = "#007aff", "29"),
    c: common_vendor.o(($event) => $event.target.style.color = "#1E1E1E", "7b"),
    d: common_vendor.o(($event) => $event.target.style.color = "#1E1E1E", "47"),
    e: common_vendor.p({
      type: "back",
      size: "24",
      color: "#1E1E1E"
    ...
    j: common_vendor.o(($event) => $data.basicInfoForm.real_name = $event.detail.value, "22"),
    k: $data.basicInfoForm.gender === 0 ? 1 : "",
    l: common_vendor.o(($event) => $data.basicInfoForm.gender = 0, "e8"),
    m: $data.basicInfoForm.gender === 1 ? 1 : "",
    n: common_vendor.o(($event) => $data.basicInfoForm.gender = 1, "03"),
    o: $data.basicInfoForm.gender === 2 ? 1 : "",
    p: common_vendor.o(($event) => $data.basicInfoForm.gender = 2, "25"),
    q: common_vendor.p({
      type: "calendar",
      size: "24",
      color: "#999"
    ...
    s: common_vendor.o(($event) => $data.basicInfoForm.birth_date = $event.detail.value, "6e"),
    t: common_vendor.p({
      type: "arrowright",
      size: "18",
      color: "#999"
    ...
    w: common_vendor.o((...args) => $options.onBirthDateChange && $options.onBirthDateChange(...args), "10"),
    x: common_vendor.p({
      type: "location",
      size: "24",
      color: "#999"
    ...
    z: common_vendor.o(($event) => $data.basicInfoForm.city = $event.detail.value, "33"),
    A: common_vendor.p({
      type: "arrowright",
      size: "18",
      color: "#999"
    ...
    B: $options.cityRange,
    C: $data.cityIndex,
    D: common_vendor.o((...args) => $options.onCityChange && $options.onCityChange(...args), "58"),
    E: common_vendor.o((...args) => $options.onCityColumnChange && $options.onCityColumnChange(...args), "d9"),
    F: common_vendor.p({
      type: "email",
      size: "24",
      color: "#999"
    ...
    H: common_vendor.o(($event) => $data.basicInfoForm.email = $event.detail.value, "51"),
    I: common_vendor.o((...args) => $options.prevRegisterStep && $options.prevRegisterStep(...args), "85"),
    J: !$options.isBasicInfoFormValid,
    K: common_vendor.o((...args) => $options.nextRegisterStep && $options.nextRegisterStep(...args), "2d")
  } : {}, {
    ...
    Q: $data.degreeIndex,
    R: common_vendor.o((...args) => $options.onDegreeChange && $options.onDegreeChange(...args), "6e"),
    S: common_vendor.p({
      type: "office",
      size: "24",
      color: "#999"
    ...
    U: common_vendor.o(($event) => $data.educationForm.school_name = $event.detail.value, "b9"),
    V: common_vendor.p({
      type: "compose",
      size: "24",
      color: "#999"
    ...
    X: common_vendor.o(($event) => $data.educationForm.major = $event.detail.value, "c1"),
    Y: common_vendor.p({
      type: "calendar",
      size: "24",
      color: "#999"
    ...
    ac: $data.yearIndex,
    ad: common_vendor.o((...args) => $options.onYearChange && $options.onYearChange(...args), "da"),
    ae: common_vendor.o((...args) => $options.prevRegisterStep && $options.prevRegisterStep(...args), "41"),
    af: !$options.isEducationFormValid,
    ag: common_vendor.o((...args) => $options.nextRegisterStep && $options.nextRegisterStep(...args), "a3")
  } : {}, {
    ...
    ak: common_vendor.o(($event) => $data.jobIntentForm.job_direction = $event.detail.value, "c2"),
    al: common_vendor.p({
      type: "location",
      size: "24",
      color: "#999"
    ...
    an: common_vendor.o(($event) => $data.jobIntentForm.expected_city = $event.detail.value, "39"),
    ao: common_vendor.p({
      type: "arrowright",
      size: "18",
      color: "#999"
    ...
    ar: common_vendor.o((...args) => $options.onExpectedCityChange && $options.onExpectedCityChange(...args), "53"),
    as: common_vendor.o((...args) => $options.onExpectedCityColumnChange && $options.onExpectedCityColumnChange(...args), "05"),
    at: $data.jobIntentForm.expected_salary_min,
    av: common_vendor.o(($event) => $data.jobIntentForm.expected_salary_min = $event.detail.value, "6d"),
    aw: $data.jobIntentForm.expected_salary_max,
    ax: common_vendor.o(($event) => $data.jobIntentForm.expected_salary_max = $event.detail.value, "a4"),
    ay: common_vendor.p({
      type: "time",
      size: "24",
      color: "#999"
    ...
    aA: common_vendor.o(($event) => $data.jobIntentForm.available_time = $event.detail.value, "1d"),
    aB: common_vendor.p({
      type: "arrowright",
      size: "18",
      color: "#999"
    ...
    aD: $data.timeIndex,
    aE: common_vendor.o((...args) => $options.onTimeChange && $options.onTimeChange(...args), "79"),
    aF: common_vendor.o((...args) => $options.prevRegisterStep && $options.prevRegisterStep(...args), "51"),
    aG: common_vendor.o((...args) => $options.completeRegister && $options.completeRegister(...args), "c8"),
    aH: !$options.isJobIntentFormValid,
    aI: common_vendor.o((...args) => $options.completeRegister && $options.completeRegister(...args), "0f")
  } : {});
}
