...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    q: common_vendor.o(($event) => $options.goToDetail($props.data), "d8"),
    r: common_vendor.p({
      type: $data.isFavorite ? "star-filled" : "star",
      size: 30,
      color: $data.isFavorite ? "#ff9500" : $props.isDark ? "#666" : "#ccc"
    }),
    s: common_vendor.o((...args) => $options.toggleFavorite && $options.toggleFavorite(...args), "b5"),
    t: $props.isDark ? "rgba(42, 42, 42, 0.8)" : "linear-gradient(135deg, #ffffff, #f8faff)",
    v: common_vendor.t($data.isApplied ? "已投递" : "投递"),
    w: $data.isApplied ? 1 : "",
    x: common_vendor.o((...args) => $options.applyForJob && $options.applyForJob(...args), "77"),
